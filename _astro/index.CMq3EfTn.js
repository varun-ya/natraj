...
var nt = {
    ...
    Xi = function (t, e, i) {
        return (i = t[e]) && I(i) ? t[e]() : He(i) && t.getAttribute && t.getAttribute(e) || i
    },
    Z = function (t, e) {
    ...
    xe = function () {
        var t = wt.length,
            e = wt.slice(0),
            i, r;
        for (Be = {}, wt.length = 0, i = 0; i < t; i++) r = e[i], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0)
    },
    si = function (t) {
    ...
    Ce = function (t, e) {
        var i = t._dp;
        return i && i.smoothChildTiming && t._ts && (t._start = z(i._time - (t._ts > 0 ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)), ke(t), i._dirty || Lt(i, t)), t
    },
    Ki = function (t, e) {
        var i;
        if ((e._time || !e._dur && e._initted || e._start < t._time && (e._dur || !e.add)) && (i = be(t.rawTime(), e), (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > M) && e.render(i, !0)), Lt(t, e)._dp && t._initted && t._time >= t._dur && t._ts) {
    ...
    Zi = function (t, e, i, r, n) {
        ...
        if (!i && t._pt && !W && (t._dur && t.vars.lazy !== !1 || !t._dur && t.vars.lazy) && Yi !== et.frame) return wt.push(t), t._lazy = [n, r], 1
    },
    $r = function u(t) {
        var e = t.parent;
    ...
    Kr = function (t, e, i, r) {
        var n = t.ratio,
            s = e < 0 || !e && (!t._start && $r(t) && !(!t._initted && Ue(t)) || (t._ts < 0 || t._dp._ts < 0) && !Ue(t)) ? 0 : 1,
            a = t._rDelay,
            o = 0,
            f, h, l;
    ...
    Qt = function (t, e, i, r) {
        var n = t._repeat,
            s = z(e) || 0,
            a = t._tTime / t._tDur;
        return a && !r && (t._time *= s / t._dur), t._dur = s, t._tDur = n ? n < 0 ? 1e10 : z(s * (n + 1) + t._rDelay * n) : s, a > 0 && !r && Ce(t, t._tTime = t._tDur * a), t.parent && ke(t), i || Lt(t.parent, t), t
    },
    xi = function (t) {
    ...
    Xe = function (t) {
        return t = ft(t)[0] || ae("Invalid scope") || {},
            function (e) {
        ...
        return X(r) ? h = l = {
            ...
            function (c, d, p) {
                ...
                if (!m) {
                    ...
                    for (m = s[_] = [], y = o ? Math.min(x, _) * h - .5 : r % x, v = x === ut ? 0 : o ? _ * l / x - .5 : r / x | 0, P = 0, S = ut, w = 0; w < _; w++) T = w % x - y, b = v - (w / x | 0), m[w] = g = f ? Math.abs(f === "y" ? b : T) : Fi(T * T + b * b), g > P && (P = g), g < S && (S = g);
    ...
    tr = function (t, e) {
        var i = $(t),
            r, n;
        return !i && dt(t) && (r = i = t.radius || ut, t.values ? (t = ft(t.values), (n = !yt(t[0])) && (r *= r)) : t = qe(t.increment)), Ct(e, i ? I(t) ? function (s) {
    ...
    ue = function (t) {
        return t.replace(Lr, function (e) {
            var i = e.indexOf("[") + 1,
                r = e.substring(i || 7, i ? e.indexOf("]") : e.length - 1).split(Ir);
    ...
    ar = function (t, e, i) {
        ...
        if (!r) {
            if (t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), ie[t]) r = ie[t];
                ...
                if (r = p = t.match(mi), !e) o = +r[0] % 360 / 360, f = +r[1] / 100, h = +r[2] / 100, s = h <= .5 ? h * (f + 1) : h + f - h * f, n = h * 2 - s, r.length > 3 && (r[3] *= 1), r[0] = Ae(o + 1 / 3, n, s), r[1] = Ae(o, n, s), r[2] = Ae(o - 1 / 3, n, s);
    ...
    ur = function (t) {
        var e = t.join(" "),
            i;
        if (Pt.lastIndex = 0, Pt.test(e)) return i = an.test(e), t[1] = bi(t[1], i), t[0] = bi(t[0], i, or(t[1])), !0
    },
    fe, et = (function () {
        var u = Date.now,
            t = 500,
...
var K = (function (u) {
    ...
    return e.to = function (r, n, s) {
        ...
        if (this !== F && h > o && r >= 0 && (h = o), h !== this._tTime || s || l) {
            if (a !== this._time && f && (h += this._time - a, r += this._time - a), c = h, b = this._start, T = this._ts, y = !T, l && (f || (a = this._zTime), (r || !n) && (this._zTime = r)), this._repeat) {
                ...
                if (c = z(h % m), h === o ? (_ = this._repeat, c = f) : (g = z(h / m), _ = ~~g, _ && _ === g && (c = f, _--), c > f && (c = f)), g = Kt(this._tTime, m), !a && this._tTime && g !== _ && this._tTime - g * m - this._dur <= 0 && (g = _), w && _ & 1 && (c = f - c, P = 1), _ !== g && !this._lock) {
                    ...
                    if (f = this._dur, o = this._tDur, x && (this._lock = 2, a = S ? f : -1e-4, this.render(a, !0), this.vars.repeatRefresh && !P && this.invalidate()), this._lock = 0, !this._ts && !y) return this;
                    hr(this, P)
                }
            }
        ...
        for (var o = [], f = this._first; f;) f._start >= a && (f instanceof V ? n && o.push(f) : (s && o.push(f), r && o.push.apply(o, f.getChildren(!0, n, s)))), f = f._next;
        return o
    }, e.getById = function (r) {
        for (var n = this.getChildren(1, 1, 1), s = n.length; s--;)
            if (n[s].vars.id === r) return n[s]
    }, e.remove = function (r) {
        return X(r) ? this.removeLabel(r) : I(r) ? this.killTweensOf(r) : (r.parent === this && Oe(this, r), r === this._recent && (this._recent = this._last), Lt(this))
        ...
        if (s._dirty) {
            for (l = s.parent; a;) f = a._prev, a._dirty && a.totalDuration(), h = a._start, h > o && s._sort && a._ts && !s._lock ? (s._lock = 1, lt(s, a, h - a._delay, 1)._lock = 0) : o = h, h < 0 && a._ts && (n -= h, (!l && !s._dp || l && l.smoothChildTiming) && (s._start += z(h / s._ts), s._time -= h, s._tTime -= h), s.shiftChildren(-h, !1, -1 / 0), o = 0), a._end > n && a._ts && (n = a._end), a = f;
...
var ln = function (t, e, i, r, n, s, a) {
    var o = new j(this._pt, t, e, 0, 1, yr, null, n),
        ...
        h = 0,
        l, c, d, p, _, m, y, v;
    for (o.b = i, o.e = r, i += "", r += "", (y = ~r.indexOf("random(")) && (r = ue(r)), s && (v = [i, r], s(v, t, e), i = v[0], r = v[1]), c = i.match(Me) || []; l = Me.exec(r);) p = l[0], _ = r.substring(f, l.index), d ? d = (d + 1) % 5 : _.substr(-5) === "rgba(" && (d = 1), p !== c[h++] && (m = parseFloat(c[h - 1]) || 0, o._pt = {
        _next: o._pt,
        p: _ || h === 1 ? _ : ",",
        s: m,
    ...
    ai = function (t, e, i, r, n, s, a, o, f, h) {
        I(r) && (r = r(n || 0, t, s));
        var l = t[e],
            c = i !== "get" ? i : I(l) ? f ? t[e.indexOf("set") || !I(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](f) : t[e]() : l,
            d = I(l) ? f ? gn : mr : ui,
            p;
    ...
    cn = function (t, e, i, r, n) {
        if (I(t) && (t = se(t, n, e, i, r)), !dt(t) || t.style && t.nodeType || $(t) || Li(t)) return X(t) ? se(t, n, e, i, r) : t;
        var s = {},
            a;
    ...
    xt, We, oi = function u(t, e, i) {
        var r = t.vars,
            ...
            b = t.timeline,
            g, w, P, S, x, k, R, D, A, q, U, B, Y;
        if (b && (!c || !n) && (n = "none"), t._ease = It(n, Gt.ease), t._yEase = l ? fr(It(l === !0 ? n : l, Gt.ease)) : 0, l && t._yoyo && !t._repeat && (l = t._yEase, t._yEase = t._ease, t._ease = l), t._from = !b && !!r.runBackwards, !b || c && !r.stagger) {
            if (D = m[0] ? Ft(m[0]).harness : 0, B = D && r[D.prop], g = Te(r, ii), _ && (_._zTime < 0 && _.progress(1), e < 0 && h && a && !d ? _.render(-1, !0) : _.revert(h && p ? me : Vr), _._lazy = 0), s) {
                ...
                if (e && (a = !1), P = at({
                    ...
                    stagger: 0,
                    parent: y
                }, g), B && (P[D.prop] = B), St(t._startAt = V.set(m, P)), t._startAt._dp = 0, t._startAt._sat = t, e < 0 && (W ? t._startAt.revert(me) : t._startAt.render(-1, !0)), t._zTime = e, !a) u(t._startAt, M, M);
                else if (!e) return
            }
            for (t._pt = t._ptCache = 0, o = p && Q(o) || o && !p, w = 0; w < m.length; w++) {
                if (x = m[w], R = x._gsap || ni(m)[w]._gsap, t._ptLookup[w] = q = {}, Be[R.id] && wt.length && xe(), U = v === m ? w : v.indexOf(x), D && (A = new D).init(x, B || g, t, U, v) !== !1 && (t._pt = S = new j(t._pt, x, A.name, 0, 1, A.render, A, 0, A.priority), A._props.forEach(function (ht) {
                    ...
                    for (P in g) tt[P] && (A = cr(P, g, t, U, x, v)) ? A.priority && (k = 1) : q[P] = S = ai.call(t, x, P, "get", g[P], U, v, 0, r.stringFilter);
...
var V = (function (u) {
    ...
    function t(i, r, n, s) {
        ...
        var o = a.vars,
            ...
            y = o.yoyoEase,
            v = r.parent || F,
            T = ($(i) || Li(i) ? yt(i[0]) : "length" in r) ? [i] : ft(i),
            b, g, w, P, S, x, k, R;
...
var ui = function (t, e, i) {
    ...
    yn = function (t, e, i) {
        ...
        return I(t[e]) ? mr : He(t[e]) && t.setAttribute ? yn : ui
    },
    gr = function (t, e) {
...
var Nt = [],
            ...
            var s = this,
                a = function () {
                    var f = E,
                        h = s.selector,
                        l;
                    return f && f !== s && f.data.push(s), n && (s.selector = Xe(n)), E = s, l = r.apply(s, arguments), I(l) && s._r.push(l), E = f, s.selector = h, s.isReverted = !1, l
                };
    ...
    we = {
        ...
        defaults: function (t) {
            return t && t.ease && (t.ease = It(t.ease, Gt.ease)), yi(Gt, t || {})
        },
        config: function (t) {
            return yi(nt, t || {})
        },
...
var On = function (t, e) {
    ...
    kn = function (t, e) {
        var i = t._targets,
            r, n, s;
        for (r in e)
            for (n = i.length; n--;) s = t._ptLookup[n][r], s && (s = s.d) && (s._pt && (s = On(s, r)), s && s.modifier && s.modifier(e[r], t, i[n], r))
    },
    Fe = function (t, e) {
        return {
            name: t,
...
var Pi, Tt, qt, _i, zt, Si, li, Cn = function () {
    ...
    Yn = function () {
        ...
        if (this.tfm) {
            ...
            r.svg && (r.renderTransform(), e.setAttribute("data-svg-origin", this.svgo || "")), n = li(), (!n || !n.isStart) && !i[L] && (wr(i), r.zOrigin && i[H] && (i[H] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1)
        }
    },
    Pr = function (t, e) {
        var i = {
    ...
    Qe = function () {
        Cn() && window.document && (Pi = window, Tt = Pi.document, qt = Tt.documentElement, zt = Ke("div") || {
            style: {}
        }, Ke("div"), L = jt(L), H = L + "Origin", zt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Sr = !!jt("perspective"), li = J.core.reverting, _i = 1)
    },
    Ci = function (t) {
        var e = t.ownerSVGElement,
            i = Ke("svg", e && e.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
            r = t.cloneNode(!0),
            n;
    ...
    Ot = function (t, e) {
        if (e) {
            var i = t.style,
                r;
            e in vt && e !== H && (e = L), i.removeProperty ? (r = e.substr(0, 2), (r === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e), i.removeProperty(r === "--" ? e : e.replace(ci, "-$1").toLowerCase())) : i.removeAttribute(e)
        }
    },
    ...
    kt = function u(t, e, i, r) {
        ...
        if (s !== "px" && !c && (n = u(t, e, i, "px")), y = t.getCTM && kr(t), (d || s === "%") && (vt[e] || ~e.indexOf("adius"))) return p = y ? t.getBBox()[o ? "width" : "height"] : t[h], N(d ? n / p * l : n / 100 * p);
    ...
    qn = function (t, e, i, r) {
        ...
        if (a.b = i, a.e = r, i += "", r += "", r.substring(0, 6) === "var(--" && (r = rt(t, r.substring(4, r.indexOf(")")))), r === "auto" && (_ = t.style[e], t.style[e] = r, r = rt(t, e) || r, _ ? t.style[e] = _ : Ot(t, e)), h = [i, r], ur(h), i = h[0], r = h[1], c = i.match(Ut) || [], g = r.match(Ut) || [], g.length) {
            for (; l = Ut.exec(r);) m = l[0], v = r.substring(o, l.index), p ? p = (p + 1) % 5 : (v.substr(-5) === "rgba(" || v.substr(-5) === "hsla(") && (p = 1), m !== (_ = c[f++] || "") && (d = parseFloat(_) || 0, b = _.substr((d + "").length), m.charAt(1) === "=" && (m = Xt(d, m) + b), y = parseFloat(m), T = m.substr((y + "").length), o = Ut.lastIndex - T.length, T || (T = T || nt.units[e] || b, o === r.length && (r += T, a.e += T)), b !== T && (d = kt(t, e, _, T) || 0), a._pt = {
                _next: a._pt,
                p: v || f === 1 ? v : ",",
                s: d,
                c: y - d,
    ...
    Gn = function (t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if (n === "all" || n === !0) r.cssText = "", o = 1;
                ...
                for (n = n.split(","), f = n.length; --f > -1;) a = n[f], vt[a] && (o = 1, a = a === "transformOrigin" ? H : L), Ot(i, a);
            o && (Ot(i, L), s && (s.svg && i.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", le(i, 1), s.uncache = 1, wr(r)))
        }
    },
    Pe = {
    ...
    Ri = function (t) {
        var e = rt(t, L);
        return Mr(e) ? _e : e.substr(7).match(Ii).map(N)
    },
    di = function (t, e) {
        var i = t._gsap || Ft(t),
            r = t.style,
    ...
    le = function (t, e) {
        ...
        var r = t.style,
            ...
            f = rt(t, H) || "0",
            h, l, c, d, p, _, m, y, v, T, b, g, w, P, S, x, k, R, D, A, q, U, B, Y, ht, de, Ht, Jt, Mt, pi, pt, Dt;
    ...
    Dr = function (t, e) {
        ...
        if (T && (l !== At || h !== At)) {
            var w = parseFloat(h) * Wt,
                ...
                S = Math.cos(w),
                x;
            w = parseFloat(l) * Wt, x = Math.cos(w), s = Le(v, s, P * x * -T), a = Le(v, a, -Math.sin(w) * -T), o = Le(v, o, S * x * -T + T)
        }
        m !== te && (b += "perspective(" + m + Rt), (r || n) && (b += "translate(" + r + "%, " + n + "%) "), (g || s !== te || a !== te || o !== te) && (b += o !== te || g ? "translate3d(" + s + ", " + a + ", " + o + ") " : "translate(" + s + ", " + a + Rt), f !== At && (b += "rotate(" + f + Rt), h !== At && (b += "rotateY(" + h + Rt), l !== At && (b += "rotateX(" + l + Rt), (c !== At || d !== At) && (b += "skew(" + c + ", " + d + Rt), (p !== 1 || _ !== 1) && (b += "scale(" + p + ", " + _ + Rt), v.style[L] = b || "translate(0, 0)"
    },
    Kn = function (t, e) {
        var i = e || this,
            r = i.xPercent,
    ...
    Zn = function (t, e, i) {
        var r = Ei({}, i._gsap),
            ...
            s = i.style,
            a, o, f, h, l, c, d, p;
        r.svg ? (f = i.getAttribute("transform"), i.setAttribute("transform", ""), s[L] = e, a = le(i, 1), Ot(i, L), i.setAttribute("transform", f)) : (f = getComputedStyle(i)[L], s[L] = e, a = le(i, 1), s[L] = f);
...
var Ar = {
    ...
    init: function (t, e, i, r, n) {
        var s = this._props,
            a = t.style,
            o = i.vars.startAt,
            f, h, l, c, d, p, _, m, y, v, T, b, g, w, P, S, x;
            ...
            if (_ !== "autoRound" && (h = e[_], !(tt[_] && cr(_, e, i, r, t, n)))) {
                if (d = typeof h, p = Pe[_], d === "function" && (h = h.call(i, r, t, n), d = typeof h), d === "string" && ~h.indexOf("random(") && (h = ue(h)), p) p(this, t, _, h, i) && (P = 1);
                    ...
                    if (o && _ in o ? (f = typeof o[_] == "function" ? o[_].call(i, r, t, n) : o[_], X(f) && ~f.indexOf("random(") && (f = ue(f)), G(f + "") || f === "auto" || (f += nt.units[_] || G(gt(t, _)) || ""), (f + "").charAt(1) === "=" && (f = gt(t, _))) : f = gt(t, _), c = parseFloat(f), v = d === "string" && h.charAt(1) === "=" && h.substr(0, 2), v && (h = h.substr(2)), l = parseFloat(h), _ in ct && (_ === "autoAlpha" && (c === 1 && gt(t, "visibility") === "hidden" && l && (c = 0), S.push("visibility", 0, a.visibility), bt(this, a, "visibility", c ? "inherit" : "hidden", l ? "inherit" : "hidden", !l)), _ !== "scale" && _ !== "transform" && (_ = ct[_], ~_.indexOf(",") && (_ = _.split(",")[0]))), T = _ in vt, T) {
                        ...
                        if (b || (g = t._gsap, g.renderTransform && !e.parseTransform || le(t, e.parseTransform), w = e.smoothOrigin !== !1 && g.smooth, b = this._pt = new j(this._pt, a, L, 0, 1, g.renderTransform, g, 0, -1), b.dep = 1), _ === "scale") this._pt = new j(this._pt, g, "scaleY", g.scaleY, (v ? Xt(g.scaleY, v + l) : l) - g.scaleY || 0, $e), this._pt.u = 0, s.push("scaleY", _), _ += "X";
                    ...
                    if (T || (l || l === 0) && (c || c === 0) && !Dn.test(h) && _ in a) m = (f + "").substr((c + "").length), l || (l = 0), y = G(h) || (_ in nt.units ? nt.units[_] : m), m !== y && (c = kt(t, _, f, y)), this._pt = new j(this._pt, T ? g : a, _, c, (v ? Xt(c, v + l) : l) - c, !T && (y === "px" || _ === "zIndex") && e.autoRound !== !1 ? zn : $e), this._pt.u = y || 0, T && x !== h ? (this._pt.b = f, this._pt.e = x, this._pt.r = En) : m !== y && y !== "%" && (this._pt.b = f, this._pt.r = Rn);
    ...
    getSetter: function (t, e, i) {
        var r = ct[e];
        return r && r.indexOf(",") < 0 && (e = r), e in vt && e !== H && (t._gsap.x || gt(t, "x")) ? i && Si === i ? e === "scale" ? Nn : In : (Si = i || {}) && (e === "scale" ? Bn : Vn) : t.style && !He(t.style[e]) ? Fn : ~e.indexOf("-") ? Ln : fi(t, e)
    },
    core: {
        _removeProperty: Ot,
        _getMatrix: di
...
jn.core.Tween;
export {
    Ar as CSSPlugin, K as TimelineLite, K as TimelineMax, V as TweenLite, jn as
        default, jn as gsap
};